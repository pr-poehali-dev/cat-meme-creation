    ...
    <section className="container mx-auto px-4 py-16 mb-16 flex flex-col md:flex-row items-center bg-white rounded-3xl shadow-xl">
      <div className="md:w-1/2 mb-8 md:mb-0">
        ...
        <p className="text-gray-700 mb-6 font-open-sans">
          Подпишитесь на нашу рассылку, чтобы первыми узнавать о новых мемах с
          котиками и интересных фактах о них.
        </p>
      ...
      <div className="md:w-1/2 flex justify-center">
        <img
          src="https://images.unsplash.com/photo-1561948955-570b270e7c36?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=450&h=300"
